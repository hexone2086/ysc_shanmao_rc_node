...
std::string ControlClient::generateMotionDataXml(float x, float y, float yaw) {
  ...
  items->InsertNewChildElement("Y")->SetText(y);
  items->InsertNewChildElement("X")->SetText(x);
  items->InsertNewChildElement("Yaw")->SetText(yaw);
  items->InsertNewChildElement("Pitch")->SetText(0.0);
  items->InsertNewChildElement("Roll")->SetText(0.0);
  items->InsertNewChildElement("Z")->SetText(0.0);
